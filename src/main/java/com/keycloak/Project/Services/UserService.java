...
public class UserService {
    ...
    public String refreshT (String refreshToken, String clientId) {

        String newToken = "";
        // System.out.println(clientId);

        try {
            // System.getenv("REALM_KEY")
            System.out.println(System.getenv("REALM_KEY"));
            String link = System.getenv("HOST_KEY")  + "/auth/realms/RefreshToken/protocol/openid-connect/token";
            // http://localhost:8080/auth/realms/RefreshToken/protocol/openid-connect/token
            // System.out.println(link);
            ...
            //   System.out.println((char) c);
              newToken += String.valueOf((char) c);
            }
